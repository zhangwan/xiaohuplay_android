 ...
 * @since 5.0.0
 */
public class SelectFriendBean extends BaseBean {

    public Data data;

    public class Data{

        public ArrayList<FriendBean> qa_user;
        public ArrayList<FriendBean> recommend_user;
        public FollowUser follow_user;
        public ArrayList<Integer> selected_user;
