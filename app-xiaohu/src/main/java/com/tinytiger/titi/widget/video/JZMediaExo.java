...
public class JZMediaExo extends JZMediaInterface implements Player.EventListener, VideoListener {
    ...
    private void newSimpleExoPlayer() {
        ...
        //  TrackSelection.Factory videoTrackSelectionFactory1 =  new AdaptiveTrackSelection.Factory();
        // videoTrackSelectionFactory1.createTrackSelections(bandwidthMeter);
...
/*        LoadControl loadControl = new DefaultLoadControl(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE),
        ...
        simpleExoPlayer = new SimpleExoPlayer.Builder(context, new DefaultRenderersFactory(context))
                .setTrackSelector(new DefaultTrackSelector(context, videoTrackSelectionFactory))
        ...
        if (jzvd.textureView != null && jzvd.textureView.getSurfaceTexture() != null) {
