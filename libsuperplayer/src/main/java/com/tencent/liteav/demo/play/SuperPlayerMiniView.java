 ...
 * @doc 视频播放器,列表版本
 */
public class SuperPlayerMiniView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener {
    ...
    public long videoTimeStart;
    public long videoTimeStop;

    public SuperPlayerMiniView(Context context) {
        super(context);
        initView(context);
    }

    public SuperPlayerMiniView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public SuperPlayerMiniView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void playWithModel(SuperPlayerModel modelV3) {
        ...
        mVodControllerSmall.setOverVideo(bgImage);
        mVodControllerLarge.setOverVideo(bgImage);
    }
    ...
    private void playVodURL(String url) {
        ...
        if (mVodPlayer != null) {
            ...
            if (videoTimeStart > 1000 && videoTimeStop > 1000) {
                videoTimeStart = System.currentTimeMillis() - (videoTimeStop - videoTimeStart);
            } else {
    ...
    private void pause() {
        ...
        videoTimeStop = System.currentTimeMillis();
...
//不允许窗口扩展到屏幕之外  clear掉了
    ...
    public void onPlayEvent(TXVodPlayer player, int event, Bundle param) {
        switch (event) {
            ...
            case TXLiveConstants.PLAY_EVT_RCV_FIRST_I_FRAME:
                ...
                mVodControllerSmall.setOverVideo("");
                mVodControllerLarge.setOverVideo("");
        ...
        switch (type) {
            ...
            case 2:
                ...
                if (BaseApp.Type4G) {
                    ...
                    if (mCurrentPlayState != SuperPlayerConst.PLAYSTATE_END) {
                        //停止播放,显示移动网络提示
                        mVodControllerSmall.showNetwork(2);
                        mVodControllerLarge.showNetwork(2);
    ...
    public void showIntroContentList(ArrayList<RecommendBean> bean) {
        mVodControllerSmall.showIntroContentList(bean);
        mVodControllerLarge.showIntroContentList(bean);
    }
