...
public class VodControllerSmall extends VodControllerBase implements View.OnClickListener {
    ...
    public VodControllerSmall(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(context);
    }

    public VodControllerSmall(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews(Context context) {
        mLayoutInflater.inflate(R.layout.clean_controller_small, this);
