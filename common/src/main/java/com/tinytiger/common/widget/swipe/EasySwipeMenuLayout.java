...
import static com.tinytiger.common.widget.swipe.State.CLOSE;

/*
 * @author Tamas
 * create at 2019/4/29 0029
 * description: 侧滑菜单
 */
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (attr == R.styleable.EasySwipeMenuLayout_contentLayout) {
                    mContentViewResID = typedArray.getResourceId(R.styleable.EasySwipeMenuLayout_contentLayout, -1);
