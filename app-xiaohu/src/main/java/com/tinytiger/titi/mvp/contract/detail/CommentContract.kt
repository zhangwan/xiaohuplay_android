...
//        fun showIntroContentList(bean: ArrayList<RecommendBean>)
        ...
        fun showCommentLike(is_like: Int, comment_id: Int,position: Int)
...
//        fun addContentCollect(is_collect:Int,content_id: String)
        ...
        fun addCommentLike(is_like:Int,content_id: String,comment_id: Int,position: Int)

//        fun doFollow(is_mutual:Int,user_id:String)

        fun delComment(content_id: String,comment_id: Int,position: Int)
