...
public class PopupController    {
    private int layoutResId;
        ...
        private void setBackgroundLevel(Context context, float level) {
...
//        mWindow = ((Activity) context).getWindow();
            ...
            // params.getBackground().mutate().setAlpha(255);
            // params.alpha = level;
            //  mWindow.setAttributes(params);
//        mWindow.setBackgroundDrawableResource(R.color.gray27);
            // mWindow.getBackground().mutate().setAlpha(255)
            // mWindow.setBackgroundDrawable(ContextCompat.getDrawable(android.R.color.transparent));

            // mWindow.setBackgroundDrawable(new ColorDrawable(0x88000000));//设置透明背景
        }
