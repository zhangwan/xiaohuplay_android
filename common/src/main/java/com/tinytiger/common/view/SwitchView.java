...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        //默认颜色原色
        final int DEFAULT_COLOR_PRIMARY = 0xFFFFCC03;
        //默认颜色主暗
        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFFFFCC03;
       ...
       // colorOffDark = a.getColor(R.styleable.SwitchView_offColorDark, 0xFFE3E3E3);
