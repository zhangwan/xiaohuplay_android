package com.tinytiger.common.view.picker.util;
...
public class ParseHelper {
    ...
    public static void initTwoLevelCityList(List<CityBean.ProvinceBean> mLevelList, List<CityEntity> pList, List<List<CityEntity>> cList) {
        List<CityEntity> twoLevelList =new ArrayList<>();


        for(CityBean.ProvinceBean prov : mLevelList){

            List<CityEntity> subCity = new ArrayList<>();
            for(CityBean.ProvinceBean.CityListBean city : prov.getCity_list()){
                subCity.add(new CityEntity(city.getShort_name()));
            }
            twoLevelList.add(new CityEntity(prov.getShort_name(),subCity));
