package com.tinytiger.titi.im.location.activity;
...
import com.tinytiger.titi.im.location.adapter.IconListAdapter;
import com.tinytiger.titi.im.location.helper.MapHelper;
import com.tinytiger.titi.im.location.helper.NimLocationManager;
import com.tinytiger.titi.im.location.model.NimLocation;
...
public class NavigationAmapActivity extends UI implements
    ...
    private MarkerOptions defaultMarkerOptions() {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.mipmap.netcafe_icon_loc));
    ...
    private void doNavigate(final NimLocation origin, final NimLocation des) {
        ...
        if (infos.size() >= 1) {
            ...
            IconListAdapter.IconListItem item = new IconListAdapter.IconListItem("在网页中打开", null, null);
            items.add(item);
            CustomAlertDialog dialog = new CustomAlertDialog(this, items.size());
            dialog.setAdapter(adapter, new DialogInterface.OnClickListener() {
                @Override
