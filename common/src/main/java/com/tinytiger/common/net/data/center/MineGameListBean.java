 ...
 * description:
 */
public class MineGameListBean extends BaseBean {
    ...
    public static class Data {
        ...
        private List<MineGameBean> data;
        ...
        public List<MineGameBean> getData() {
            return data;
        }

        public void setData(List<MineGameBean> data) {
            this.data = data;
        }
