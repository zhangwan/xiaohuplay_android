...
import com.tinytiger.common.widget.picbrowser.glide.progress.OnProgressListener;
import com.tinytiger.common.widget.picbrowser.glide.progress.ProgressManager;
import com.tinytiger.common.widget.picbrowser.tool.common.HandlerUtils;
...
import com.tinytiger.common.widget.picbrowser.view.watermask.WaterMaskManager;
...
//        tv_save.setImageResource(ImagePreview.getInstance().getDownIconResId());
...
//                DonwloadSaveImg.donwloadImg(context, currentItemOriginPathUrl);
//                ToastUtils.show(BaseApp._instance, "图片已保存至相册");
            }
        });
        dialog.show();
    ...
    public void setSaveEnable(boolean enable) {
        tv_save.setEnabled(enable);
        if (enable) {
            tv_save.setTextColor(ContextCompat.getColor(this, R.color.white));
            tv_save.setBackgroundResource(R.drawable.stroke_rectangle_15_white);
        } else {
            tv_save.setTextColor(ContextCompat.getColor(this, R.color.grayAA));
            tv_save.setBackgroundResource(R.drawable.stroke_rectangle_15_aaaaaa);
        }
    }
