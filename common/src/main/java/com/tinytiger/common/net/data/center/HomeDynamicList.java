 ...
 * description:
 */
public class HomeDynamicList extends BaseBean {
    ...
    public static class Data {
        ...
        private List<HomeDynamicBean> data;
        ...
        public List<HomeDynamicBean> getData() {
            return data;
        }

        public void setData(List<HomeDynamicBean> data) {
            this.data = data;
        }
