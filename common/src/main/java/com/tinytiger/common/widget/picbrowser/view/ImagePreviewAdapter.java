package com.tinytiger.common.widget.picbrowser.view;
...
import com.tinytiger.common.widget.picbrowser.ImagePreview;
import com.tinytiger.common.widget.picbrowser.bean.ImageInfo;
import com.tinytiger.common.widget.picbrowser.glide.FileTarget;
import com.tinytiger.common.widget.picbrowser.glide.ImageLoader;
import com.tinytiger.common.widget.picbrowser.tool.common.NetworkUtil;
import com.tinytiger.common.widget.picbrowser.tool.image.ImageUtil;
import com.tinytiger.common.widget.picbrowser.tool.ui.PhoneUtil;
import com.tinytiger.common.widget.picbrowser.tool.ui.ToastUtil;
import com.tinytiger.common.widget.picbrowser.view.helper.FingerDragHelper;
import com.tinytiger.common.widget.picbrowser.view.helper.ImageSource;
import com.tinytiger.common.widget.picbrowser.view.helper.SubsamplingScaleImageViewDragClose;
import com.tinytiger.common.widget.picbrowser.view.photoview.PhotoView;
            ...
            if (cacheFile != null && cacheFile.exists()) {
                ...
                if (isCacheIsGif) {
                    ...
                    if (imageView != null) {
                        ...
                        //给图片加水印效果
//                        String imagePath = WaterMaskManager.getWaterMask(activity, cacheFile.getAbsolutePath());
...
//            }
    ...
    private void loadSuccess(File resource, SubsamplingScaleImageViewDragClose imageView, ImageView imageGif,
        ...
        String waterPath = resource.getAbsolutePath();

        boolean isCacheIsGif = ImageUtil.isGifImageWithMime(waterPath);
        if (isCacheIsGif) {
            loadGifImageSpec(waterPath, imageView, imageGif, progressBar);
        } else {
            //给图片加水印效果
//            waterPath = WaterMaskManager.getWaterMask(activity, waterPath);
            loadImageSpec(waterPath, imageView, imageGif, progressBar);
        }
    }
    ...
    private void loadImageSpec(final String imagePath, final SubsamplingScaleImageViewDragClose imageView,
        ...
        imageView.setOnImageEventListener(new SubsamplingScaleImageViewDragClose.OnImageEventListener() {
            ...
            public void onReady() {
                progressBar.setVisibility(View.GONE);
                if (activity instanceof ImagePreviewActivity) {
                    ((ImagePreviewActivity) activity).setSaveEnable(true);
                }
            }
