 ...
 * @copyright 小虎互联科技
 * @doc 圆形进度条（可设置 线性渐变-背景色-进度条颜色-圆弧宽度）
 */
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.color_ffcc03));
        ...
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, getResources().getColor(R.color.color_ffcc03));
        endColor = typedArray.getColor(R.styleable.CirclePercentView_circleEndColor, getResources().getColor(R.color.black_FFE807));
        typedArray.recycle();
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(rectF, -45, 3.6f * progressPercent, false, mPaint);   //画比例圆弧
    }
