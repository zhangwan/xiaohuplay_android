...
public class RadarView extends View {
    ...
    private void init() {
        //雷达区画笔初始化
        mainPaint = new Paint();
        mainPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorF0));
        mainPaint.setAntiAlias(true);
        mainPaint.setStrokeWidth(1);
        mainPaint.setStyle(Paint.Style.STROKE);
        mainPaint.setPathEffect(new CornerPathEffect(10f));
        //雷达图向外的直线画笔
        linePaint = new Paint();
        linePaint.setColor(ContextCompat.getColor(getContext(), R.color.colorF0));
        ...
        textPaint.setTextSize(ScreenUtil.dp2px(getContext(), 10f));
        textPaint.setStrokeWidth(1);
        textPaint.setAntiAlias(true);
        //数据区（分数）画笔初始化
        valuePaint = new Paint();
        valuePaint.setColor(ContextCompat.getColor(getContext(), R.color.color_FFE272));
        valuePaint.setAntiAlias(true);
        valuePaint.setStyle(Paint.Style.FILL);
        valuePaint.setPathEffect(new CornerPathEffect(10f));
...
//        canvas.drawText(titles.get(4), x5 - dis5, y5 - fontHeight / 5, textPaint);
    ...
    //设置雷达图向外的直线画笔颜色
    public void setLinePaint(Paint valuePaint) {
        this.linePaint = valuePaint;
        postInvalidate();
    }
    ...
    //设置各门得分
    public void setData(List<Float> data, boolean isShowAnimation) {
