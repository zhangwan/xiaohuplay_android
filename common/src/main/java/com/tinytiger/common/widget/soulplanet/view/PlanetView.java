...
public class PlanetView extends View {
    ...
    private void init(Context context) {
        ...
        signTextSize = Dp2PxUtils.sp2px(context, 9.0f);
        ...
        otherPaint.setTextSize((float) Dp2PxUtils.sp2px(context, 9.0f));
        matchPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        matchPaint.setColor(0xFFFFFFFF);
        matchTextSize = Dp2PxUtils.sp2px(context, 6.0f);
        matchPaint.setTextSize((float) matchTextSize);
        setLayerType(LAYER_TYPE_SOFTWARE, null);
        int startX = Dp2PxUtils.sp2px(context, 50.0f);
        starWidth = Dp2PxUtils.sp2px(context, 20.0f);
        starMarginTop = 0;
