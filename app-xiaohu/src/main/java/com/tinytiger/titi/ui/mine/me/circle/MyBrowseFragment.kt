 ...
 * 我浏览的圈子
 */
class MyBrowseFragment : BasisFragment<AddCirclePresenter>(), CircleView {

    companion object {

        fun getInstance(): MyBrowseFragment {
            val fragment = MyBrowseFragment()
            val bundle = Bundle()
    ...
    fun loadData() {
        basePresenter?.getHistoryList(page)
    }
