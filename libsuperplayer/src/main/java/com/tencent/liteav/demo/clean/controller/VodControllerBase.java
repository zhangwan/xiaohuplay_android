...
public abstract class VodControllerBase extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
  ...
  //  protected LinearLayout ll_right;
    ...
    public VodControllerBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VodControllerBase(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDown(MotionEvent e) {
                ...
                if (mVideoGestureUtil != null) {
                    mVideoGestureUtil.reset(VodControllerBase.this.getWidth(), mSeekBarProgress.getProgress());
                }
                return true;
            }
    ...
    private static class HideViewControllerViewRunnable implements Runnable {
        public WeakReference<VodControllerBase> mWefControlBase;

        public HideViewControllerViewRunnable(VodControllerBase base) {
